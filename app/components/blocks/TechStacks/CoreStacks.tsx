export const CORE_STACKS = [
  ...
  {label: 'React Router', icon: 'https://cdn.simpleicons.org/reactrouter/CA4245', color: '#CA4245', desc: '', href: ''},
  {label: 'react', icon: 'https://cdn.simpleicons.org/react/61DAFB', color: '#61DAFB', desc: '', href: ''},
